...
import { StyleSheet, Text, ScrollView, Picker, View, TextInput, Alert, Keyboard, ActivityIndicator, TouchableOpacity, Platform, AsyncStorage, Linking } from 'react-native';
								...
								<>
									{manifestacao?.meta_box?.atendimentos?.map((atendimento, idx) => {
										return <View key={idx}>
											...
											{manifestacao.meta_box['anexo-resposta'][0] &&
												<>
													<Text
														style={{ ...styles.text, fontWeight: 'bold' }}
